...
class_weights = class_weight.compute_class_weight(class_weight='balanced', classes=np.unique(y_true),y= y_true.numpy())
...
print((-2.0000*log(0.3078) - 0.6667*log(0.0983) -0.6667*log(0.3313)
       -1.0000*log(0.6218) - 0.6667*log(0.7574) -1.0000*log(0.7326))/6)
print()

#ignore_index = 0
loss = nn.CrossEntropyLoss(weight=class_weights,ignore_index=0) #new_class_weight[0, 5/2/3, 5/2/2 ]
cost = loss(y_logit,y_true)
print(y_prob)
print("loss unbalance class ignore index 0:",cost)
print((-0*log(0.3078) - 0.833333*log(0.0983) -0.833333*log(0.3313)
       -1.25*log(0.6218) - 0.833333*log(0.7574) -1.25*log(0.7326))/5)
